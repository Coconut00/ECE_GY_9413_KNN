...
bool knn_cuda_global(const float * ref,
    ...
    // start memopry allocation and copy data timer-----------------------------
    ...
    printf(" memory allocation : %f ms \n", time);
    // end memopry allocation and copy data timer-----------------------------

    // start compute dist timer-----------------------------
    cudaEventCreate(&startTime);
    cudaEventCreate(&endTime);
    cudaEventRecord(startTime, 0);
    ...
    cudaEventSynchronize(endTime);
    cudaEventElapsedTime(&time, startTime, endTime);
    printf(" compute dist : %f ms \n", time);
    // end compute dist timer-----------------------------
    ...
    cudaEventSynchronize(endTime);
    cudaEventElapsedTime(&time, startTime, endTime);
    printf(" data back : %f ms \n", time);
    printf("---------------------");
    // end copy data back timer-----------------------------
